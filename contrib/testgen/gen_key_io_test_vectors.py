...
bech32_templates = [
  ...
  ('"aurum',    0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('"aurum',    0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('"aurum',    1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('taurum',    0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('taurum',    0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('taurum',    2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('raurum',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('raurum',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('raurum', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('taurum',   17, 32, False, False, False),
  ('raurum',  3,  1, False, False, False),
  ('aurum',   15, 41, False, False, False),
  ('taurum',    0, 16, False, False, False),
  ('raurum',  0, 32, True,  False, False),
  ('aurum',    0, 16, True,  False, False),
  ('taurum',    0, 32, False, True,  False),
  ('raurum',  0, 20, False, False, True)
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['aurum', 'taurum', 'raurum']:
