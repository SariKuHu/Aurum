...
"""Verify that starting aurum with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start aurum with -h for help text")
        ...
        self.log.info("Start aurum with -version for version information")
