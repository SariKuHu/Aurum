...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("gold bar");
    case mBTC: return QString("biscuit");
    case uBTC: return QString::fromUtf8("sovereign");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ACG");
    case mBTC: return QString("Milli-ACG (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-ACG (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case AU: return QString("Nano-ACG (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
