    ...
    m_network_style(networkStyle)
{
    ...
    // See https://doc.qt.io/qt-5/gallery.html
        progressBar->setStyleSheet("QProgressBar { background-color: #141414; font-size: 10px; font-family: Diversa Sans Com Black, sans-recif; font-weight: bold; max-height: 10px; color: #EAEAEA; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #212121, stop: 1 #DCB242); border-radius: 7px; margin: 0px; max-height: 10px;  }");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Aurum Crypto Gold address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and aurum: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Aurum Crypto Gold addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Aurum Crypto Gold addresses"));
    ...
    openAction->setStatusTip(tr("Open a aurum: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Aurum Crypto Gold command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Aurum Crypto Gold network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
